            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-6">
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                        ...
                        <div class="bg-yellow-400 w-full p-4 border-4 border-pink-600 rounded-bl-lg rounded-tr-lg">
                            <span class="font-bold text-4xl text-indigo-700">Onitiana</span>
                        </div>

                        <div class="bg-gradient-to-bl from-yellow-400 via-lime-200 to-purple-300 bg-yellow-400 w-full rounded-bl-lg rounded-tr-lg flex items-center justify-center">
                            <div class="w-full p-4 bg-pink-600">
                                <span class="font-bold text-4xl text-indigo-700">Tim</span>
                            </div>
                        </div>
